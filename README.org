...
#+begin_html
<img src="assets/run-tests-demo.gif" alt="Demo Carbon running tests">
#+end_html

/The above example was generated with [[https://github.com/charmbracelet/vhs][VHS]] ([[./assets/run-tests-demo.exs][source code]])/.
...
cd vendor/carbon && git switch -d v0.7-alpha
#+end_src
