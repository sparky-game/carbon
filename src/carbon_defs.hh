...
/**
 * @brief Packed version number as [0x00, 0xMM, 0xNN, 0xPP].
 */
#define CARBON_VERSION ((CARBON_VERSION_MAJOR << 16) | (CARBON_VERSION_MINOR << 8) | (CARBON_VERSION_PATCH << 0))
