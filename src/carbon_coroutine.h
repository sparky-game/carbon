...
CBNDEF_AKA(cbn::co, ID, carbon_coroutine_id);
...
CBNDEF_AKA(cbn::co, Alive, carbon_coroutine_alive);
...
CBNDEF_AKA(cbn::co, Yield, carbon_coroutine_yield);
...
CBNDEF_AKA(cbn::co, SleepRead, carbon_coroutine_sleep_read);
...
CBNDEF_AKA(cbn::co, SleepWrite, carbon_coroutine_sleep_write);
...
CBNDEF_AKA(cbn::co, Wakeup, carbon_coroutine_wakeup);
