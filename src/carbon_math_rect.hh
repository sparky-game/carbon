...
struct CBN_Rect : CBN_Rect_t {
  ...
  bool operator==(const CBN_Rect &r) const { return x == r.x && y == r.y && w == r.w && h == r.h; }

  bool Contains(const CBN_Vec2 &p) const { return carbon_math_rect_contains(*this, p); }

  bool Overlaps(const CBN_Rect &r) const { return carbon_math_rect_overlaps(*this, r); }

  CBN_Rect Intersection(const CBN_Rect &r) const { return carbon_math_rect_intersection(*this, r); }

  void Scale(const f32 s) { carbon_math_rect_scale(this, s); }
};
