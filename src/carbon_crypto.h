...
CBNDEF_AKA(cbn::crypto::b64, Encode, carbon_crypto_base64_encode);
...
CBNDEF_AKA(cbn::crypto::crc32, Compute, carbon_crypto_crc32);
...
CBNDEF_AKA(cbn::crypto::sha1, Compute, carbon_crypto_sha1);
...
CBNDEF_AKA(cbn::crypto::sha1, ToHexString, carbon_crypto_sha1_to_hex_cstr);
...
CBNDEF_AKA(cbn::crypto::sha1, AsHexString, carbon_crypto_sha1_as_hex_cstr);
...
CBNDEF_AKA(cbn::crypto::sha256, Compute, carbon_crypto_sha256);
...
CBNDEF_AKA(cbn::crypto::sha256, ToHexString, carbon_crypto_sha256_to_hex_cstr);
...
CBNDEF_AKA(cbn::crypto::sha256, AsHexString, carbon_crypto_sha256_as_hex_cstr);
...
CBNDEF_AKA(cbn::crypto::keccak256, Compute, carbon_crypto_keccak256);
...
CBNDEF_AKA(cbn::crypto::keccak256, ToHexString, carbon_crypto_keccak256_to_hex_cstr);
