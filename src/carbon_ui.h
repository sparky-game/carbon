...
CBNDEF_TAKA(cbn::ui, Anchor, CBN_UI_Anchor);
...
CBNDEF_AKA(cbn::ui, AnchorPosition, carbon_ui_anchor_position);
...
//CBNDEF_AKA(cbn::ui, HStack, carbon_ui_hstack);
...
//CBNDEF_AKA(cbn::ui, VStack, carbon_ui_vstack);
