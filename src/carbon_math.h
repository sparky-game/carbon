...
/**
 * @brief The mathematical constant e (<https://en.wikipedia.org/wiki/E_(mathematical_constant)>).
 */
#define CARBON_E 2.71828182845904523536
CBNDEF_iAKA(cbn::math, literals, e, CARBON_E);
...
/**
 * @brief The mathematical constant π (<https://en.wikipedia.org/wiki/Pi>).
 */
#define CARBON_PI 3.14159265358979323846
CBNDEF_iAKA(cbn::math, literals, pi, CARBON_PI);
#define CARBON_1_PI 0.31830988618379067153
CBNDEF_iAKA(cbn::math, literals, inv_pi, CARBON_1_PI);
...
#define CARBON_2PI_3 2.09439510239319549230
...
#define CARBON_4PI_3 4.18879020478639098461
...
CBNDEF_iAKA(cbn::math, literals, sqrt2, CARBON_SQRT2);
#define CARBON_1_SQRT2 0.70710678118654752440
CBNDEF_iAKA(cbn::math, literals, inv_sqrt2, CARBON_1_SQRT2);

/**
 * @brief The algebraic number √3 (<https://en.wikipedia.org/wiki/Square_root_of_3>).
 */
#define CARBON_SQRT3 1.73205080756887729352
CBNDEF_iAKA(cbn::math, literals, sqrt3, CARBON_SQRT3);
