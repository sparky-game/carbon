...
enum {
  ...
  CARBON_DRAWCANVAS_FLAG_FRUSTUM_CULLING  = 1 << 3,
};
...
/**
 * @brief A 3D cube (d6) mesh.
 */
CBNDEF CBN_Mesh const carbon_drawcanvas_cube;

/**
 * @brief A 3D octahedron (d8) mesh.
 */
CBNDEF CBN_Mesh const carbon_drawcanvas_octahedron;

/**
 * @brief A 3D pentagonal trapezohedron (d10) mesh.
 */
CBNDEF CBN_Mesh const carbon_drawcanvas_pentatrapezohedron;

/**
 * @brief A 3D dodecahedron (d12) mesh.
 */
CBNDEF CBN_Mesh const carbon_drawcanvas_dodecahedron;
 ...
 */
CBNDEF f32 carbon_drawcanvas_get_text_width(const char *txt, usz size);
...
/**
 * @brief Draws text to the canvas with a specific color, font and an outline.
 * @param dc The DrawCanvas object.
 * @param f The font to use.
 * @param txt The text to draw.
 * @param position The position (top-left corner) to draw the text to.
 ...
 * @param color The color to draw the text with.
 */
CBNDEF void carbon_drawcanvas_text_with_font_with_outline(CBN_DrawCanvas *dc, const CBN_Font *f, const char *txt, CBN_Vec2 position, usz size, u32 color);
