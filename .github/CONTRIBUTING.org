...
We use it to be able to sell copies of the *commercial license* of /Carbon/, for you to use it without releasing your software under GNU's *AGPL-3.0-only*. That paid license is just a legal agreement, it doesn't contain any modified versions of the library and *NEVER* will.
#+end_quote
