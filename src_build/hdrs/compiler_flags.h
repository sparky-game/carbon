...
#define WARNS        "-Wall -Wextra -Werror=format -Werror=switch-enum -Wno-return-type-c-linkage -Wno-strict-aliasing"
...
#elif defined(_WIN32)
#define LDFLAGS "-ldnsapi -lws2_32 -lopengl32 -lgdi32 -lwinmm -lntdll -lpthread -static"
